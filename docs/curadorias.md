# Regulamento Interno das Curadorias
...
As curadorias ativas **produzem relatórios**, listados abaixo e no menu da página de documentação:

* [curadoria**001**](reports/curadoria001.md)

* [curadoria**003**](reports/curadoria003.md)

Para sugerir e incluir novas curadorias, ver [listagem das solicitações](data/curadoria.csv) (editável [nesta planilha colaborativa](https://docs.google.com/spreadsheets/d/1-LqoLFCMPWs0UHrY3WXSV10S9eYIxpshOzDXsIFXlJA/edit#gid=770195002).
